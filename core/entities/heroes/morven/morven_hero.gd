...
## Implementation of Morven

const DefScript = preload("res://data/heroes/morven_definition.gd")
...
func _create_visual_mesh() -> void:
	if not has_node("MorvenVisual"):
		...
		body_mat.albedo_color = Color(0.15, 0.55, 0.18)
