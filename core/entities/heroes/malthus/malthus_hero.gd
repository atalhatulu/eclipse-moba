...
## Implementation of Malthus

const DefScript = preload("res://data/heroes/malthus_definition.gd")
...
func _create_visual_mesh() -> void:
	if not has_node("MalthusVisual"):
		...
		body_mat.albedo_color = Color(0.20, 0.28, 0.22)
