...
## Implementation of Drogas

const DefScript = preload("res://data/heroes/drogas_definition.gd")
...
func _create_visual_mesh() -> void:
	if not has_node("DrogasVisual"):
		...
		body_mat.albedo_color = Color(0.38, 0.35, 0.30)
