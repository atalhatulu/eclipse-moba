...
## Implementation of Malakor (The High Tactician)

const DefScript = preload("res://data/heroes/malakor_definition.gd")
...
func _create_visual_mesh() -> void:
	if not has_node("MalakorVisual"):
		...
		body_mat.albedo_color = Color(0.80, 0.65, 0.20)
