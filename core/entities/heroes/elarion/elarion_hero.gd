...
## Implementation of Elarion

const DefScript = preload("res://data/heroes/elarion_definition.gd")
...
func _create_visual_mesh() -> void:
	if not has_node("ElarionVisual"):
		...
		body_mat.albedo_color = Color(0.20, 0.60, 0.95)
